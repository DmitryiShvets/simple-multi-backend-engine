...
Dx12CommandList::Dx12CommandList(Dx12GpuStorageMT &storage)
    : m_storage(storage) {}
...
void Dx12CommandList::setDepthBias(float constant_factor,
                                     float slope_factor) {
...
void Dx12CommandList::drawIndexed(uint32_t index_count,
