...
std::vector<glm::vec3> CurveUtils::createCircleGeometry(float x, float y,
                                                        float radius,
                                                        float segments) {
  ...
  for (int i = 0; i < segments; i++) {
    ...
    vertices.emplace_back(
        glm::vec3(y + sin1 * radius, x + cos2 * radius, y + sin2 * radius));
  }
  return vertices;
}

std::vector<glm::vec3>
CurveUtils::createCircleCoords(float x, float y, float radius, float segments) {
...
std::vector<glm::vec3> CurveUtils::getSegmentSubdivision(const glm::vec3 &p1,
                                                         const glm::vec3 &p2,
                                                         float thickness) {
...
std::vector<float>
CurveUtils::createLineGeometry(const std::vector<glm::vec3> &points,
                               float thickness) {
...
std::vector<glm::vec3> CurveUtils::createRectangleCoords(float centerX,
                                                         float centerY,
                                                         float sizeX,
                                                         float sizeY) {
  std::vector<glm::vec3> coords;
