...
int main() {
  ...
  try {
    ...
    engine.createSphere("1", 0.5f, 32, 32, glm::vec3{0.0f, 0.0f, -1.0f});
    engine.createSphere("2", 0.5f, 32, 32, glm::vec3{1.f, 0.0f, -1.0f});
    engine.createSphere("3", 0.5f, 32, 32, glm::vec3{1.f, 1.0f, -1.0f});
