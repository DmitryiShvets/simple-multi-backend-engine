...
void ImGuiBackend::init(Window::IMainWindow &window,
...
void ImGuiOpenGLBackend::init(Window::IMainWindow &window,
                              const UIBackendConfig &config) {
  if (m_initialized) {
    return;
  }
...
void ImGuiVulkanBackend::init(Window::IMainWindow &window,
                              const UIBackendConfig &config) {
  if (m_initialized) {
    return;
  }
