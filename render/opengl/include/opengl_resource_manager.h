...
private:
  ...
  Core::ResourceOwner<Material> m_materials;
  Core::ResourceOwner<UniformBuffer> m_uniform_buffers;
  Core::ResourceOwner<OpenGLDescriptorSet> m_descriptor_sets;
  Core::ResourceOwner<OpenGLDescriptorSetLayout> m_ds_layouts;
};
} // namespace Render::OpenGL
